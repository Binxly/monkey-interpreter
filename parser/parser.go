...
func New(l *lexer.Lexer) *Parser {
	...
	// Read 2 tokens to set both curToken and peekToken
	p.nextToken()
	p.nextToken()
...
// constructs root of AST, an *ast.Program
// iterates, calling parseStatement
// adds stmt to Statements slice of AST root
...
// same as above, but with curToken
